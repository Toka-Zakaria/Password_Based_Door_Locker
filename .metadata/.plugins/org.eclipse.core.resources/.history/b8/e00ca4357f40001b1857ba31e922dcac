 ...
 *
 * [Description]: Application based on ATmega16 ECU to be responsible to control system,
 *                connected to Motor act as door, Buzzer and LED to make loud sound if any
 *                one try to hack the system and external EEPROM to store the password
 *                received from another ECU using UART communication protocol
 *****************************************************************************************/
