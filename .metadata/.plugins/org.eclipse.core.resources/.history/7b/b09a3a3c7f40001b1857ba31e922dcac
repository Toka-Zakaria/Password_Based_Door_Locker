 ...
 *
 * [Description]: Application based on ATmega16 ECU to be responsible to human interface,
 *                connected to LCD to display some messages to user and Keypad to enable him
 *                to communicate with another ECU who is control another system
...
int main(void)
{
	...
	}/*end of the first time to log in*/
