...
uint8 select_Option (void)
{
	...
	/*
	 * wait for 1 second after press button on the keypad
	 * to avoid repeating enter character more than one time
	 * if the next step of using this function using keypad too
	 */
	 _delay_ms(1000);
